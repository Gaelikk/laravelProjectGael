                        ...
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <form method="post" action="{{url("/loginCheck")}}">
                                ...
                                <div class="form-outline form-white mb-4">
                                    <input type="text" id="typeEmailX" placeholder="Email"
                                ...
                                <div>
                                    <p class="mb-0">No tens compte? <a href="{{url('/register')}}"
                                                                       class="text-white-50 fw-bold">Registra't</a></p>
                                    <br>
                                </div>
                                <a class="btn btn-outline-light btn-lg px-5" href="{{ url('/') }}" type="submit">Torna
                                    Enrere</a>
